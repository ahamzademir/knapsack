...
public class separateInput {
    ...
    public void SeparateInput() throws IOException {
        ...
        String pathname = "D:\\ders\\Current\\Analysis of Algorithms\\Homeworks\\2\\test4.txt";
    ...
    //output için total değer = largestNO yazdırmak gerek
    //çantanın hangi değerlerini aldığımızı yazdırmak için largestIndex No yazdırmamız gerek
